...
#     , classifier
#     , training_set:LazyFrameDataset,batch_size:int, device):
...
#         for data in tqdm(self.dataloader, desc="Training process"):
...
#             # Combined loss
#             total_batch_loss = reconstruction_loss + classification_loss
#             print("TOTAL LOSS: ", total_batch_loss)
#             print("\rAUTOENCODER LOSS: ",reconstruction_loss)
#             print("\rCLASSIFIER LOSS: ",classification_loss)
#             # Backward pass
...
#             self._signal_tuner(trial, avg_loss, epoch)
...
#                     message=f"Model saved. New best 'total_loss': {avg_loss} at epoch {epoch + 1}",
#                 )
#     def free(self) -> None:
#         with torch.no_grad():
